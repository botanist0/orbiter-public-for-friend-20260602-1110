...
$credential = Get-Credential -UserName $selectedAccount.address -Message "Enter the Gmail app password for Orbiter. Do not use your normal Google password."
$encrypted = ConvertFrom-SecureString $credential.Password
